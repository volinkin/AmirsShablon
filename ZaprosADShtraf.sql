select
   DNum."Num",
   CM."JudicalUid",
   (select first(1) pp."PersonName" from "ParticipantPerson" pp where pp."CaseId"=CM."OID" and pp."Kind"=31),
   ti."Name",
   AP."OID",
   BP."SimplePenalty",
...
where CM."ProcKind"=1 and DNum."Num" like '%:paramYear' and fd."DecisionDate" is not null and BP."SimplePenalty" = 30
